...
## 0. Estudiantes
Explica el código de manera clara y sencilla, como si se lo estuvieras explicando a un estudiante de desarrollo web. Comenta el codigo de manera detallada pare que el estudiante pueda entenderlo y pon si es autentcaio o peticion y demas.
...
- **Estilos (CSS):** Prioriza el uso de CSS Vanilla eficiente. Crea sistemas de diseño basados en variables CSS (Custom Properties), Flexbox y CSS Grid. Evita TailwindCSS u otros frameworks de utilidades similares a menos que el usuario lo solicite explícitamente y precise la versión a utilizar.
...
## 5 Seguridad
- **Seguridad:** Implementa medidas de seguridad básicas para proteger el sitio web de ataques maliciosos.
